...
import { useState, useEffect, useRef } from "react" import { motion } from "framer-motion" import { Gift, Star, Shield, ArrowRight, Check, Clock, AlertTriangle, BookOpen, Heart, Award, Play, ThumbsUp, User, Users, MessageCircle, FileText } from "lucide-react" import { Button } from "@/components/ui/button" import { Card, CardContent } from "@/components/ui/card" import { CountdownTimer } from "@/components/countdown-timer" import { bonuses, getPersonalizedContent } from "@/lib/quiz-data" import { enviarEvento } from '../../lib/analytics' import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs"

export default function ResultPage() { const [unlockedBonuses, setUnlockedBonuses] = useState<number[]>([]) const [totalValue, setTotalValue] = useState(0) const [isLoaded, setIsLoaded] = useState(false) const [recentBuyers, setRecentBuyers] = useState(3) const [userGender, setUserGender] = useState<string>("") const contentRef = useRef<HTMLDivElement>(null)

useEffect(() => { const savedBonuses = localStorage.getItem("unlockedBonuses") const savedValue = localStorage.getItem("totalValue") const savedGender = localStorage.getItem("userGender")
...
const handlePurchase = () => { try { enviarEvento('clicou_comprar', { posicao: 'principal' }); } catch (error) { console.error('Erro ao registrar evento de clique:', error); } window.open("
...
const getPersonalizedTitle = () => { if (userGender === "MASCULINO") { return "DE RECHAZADO A DESEADO" } else if (userGender === "FEMININO") { return "DE RECHAZADA A DESEADA" } return "DE RECHAZADO(A) A DESEADO(A)" }

const getPersonalizedCTA = () => { if (userGender === "MASCULINO") { return "RECONQUISTAR A ELLA AHORA" } else if (userGender === "FEMININO") { return "RECONQUISTAR A ÉL AHORA" } return "RECONQUISTAR AHORA" }

const getPersonalizedPronoun = () => { return userGender === "FEMININO" ? "él" : "ella"; }

return ( <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black p-4" ref={contentRef}> {/* Navegação interna */}
  ...
  <div className="max-w-6xl mx-auto">
    ...
    >
      ...
      <div className="max-w-4xl mx-auto mb-12">
                ...
                <CardContent className="p-4">
                  <ul className="text-gray-300 space-y-2 text-right">
                    <li className="flex items-start justify-end">
                      <span>Primeras señales de curiosidad {getPersonalizedPronoun() === "él" ? "de él" : "de ella"}</span>
              ...
              <Card className="bg-gray-800 border border-orange-500 md:w-5/12 md:pl-8 hidden md:block">
                <CardContent className="p-4">
                  <ul className="text-gray-300 space-y-2">
                    <li className="flex items-start">
                      <Check className="w-4 h-4 text-green-400 mr-2 mt-1" />
                      <span>Contacto directo y reaproximación</span>
                    </li>
                    <li className="flex items-start">
                      <Check className="w-4 h-4 text-green-400 mr-2 mt-1" />
              ...
              <CardContent className="p-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <ul className="space-y-3 text-gray-300">
                      ...
                      <li className="flex items-start">
                        <Check className="w-5 h-5 text-green-400 mr-3 mt-1" />
                        <span>Todavía amas a {getPersonalizedPronoun()} y quieres una segunda oportunidad</span>
                      </li>
                      <li className="flex items-start">
                        <Check className="w-5 h-5 text-green-400 mr-3 mt-1" />
                        <span>Ya has intentado de todo, pero nada ha funcionado hasta ahora</span>
                      </li>
                      <li className="flex items-start">
                        <Check className="w-5 h-5 text-green-400 mr-3 mt-1" />
                  ...
                  <div>
                    ...
                    <ul className="space-y-3 text-gray-300">
                      ...
                      <li className="flex items-start">
                        <AlertTriangle className="w-5 h-5 text-red-400 mr-3 mt-1" />
                        <span>La relación involucraba abuso o violencia</span>
                      </li>
                      <li className="flex items-start">
                        <AlertTriangle className="w-5 h-5 text-red-400 mr-3 mt-1" />
                ...
                <div className="mt-8 bg-orange-100 p-4 rounded-lg text-center">
                  ...
                  <p className="text-orange-700">
                    ...
                    activando gatillos psicológicos que despiertan el deseo natural {getPersonalizedPronoun() === "él" ? "de él" : "de ella"} por ti.
                  </p>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="max-w-4xl mx-auto">
            <Tabs defaultValue="traicao" className="w-full">
              <TabsList className="grid grid-cols-3 mb-6">
                <TabsTrigger value="traicao" className="text-sm md:text-base">Después de Infidelidad</TabsTrigger>
                <TabsTrigger value="desgaste" className="text-sm md:text-base">Después de Desgaste</TabsTrigger>
                <TabsTrigger value="brigas" className="text-sm md:text-base">Después de Peleas</TabsTrigger>
              </TabsList>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <Card className="bg-white shadow-lg">
                    <CardContent className="p-6">
                      ...
                      <p className="text-gray-700 mb-3">
                        "Después de descubrir la infidelidad, pensé que nunca más podría confiar en ella. 
                        Pero el Módulo 3 me mostró cómo reconstruir la confianza paso a paso. Hoy estamos 
                        juntos desde hace 8 meses y nuestra relación está más fuerte que antes."
                      </p>
                  ...
                  <Card className="bg-white shadow-lg">
                    <CardContent className="p-6">
                      ...
                      <p className="text-gray-700 mb-3">
                        "Él me fue infiel y terminó conmigo por mensaje. Estaba destruida hasta encontrar este método. Seguí exactamente el protocolo de 72 horas 
                        y en 18 días él estaba implorando volver. ¡Hoy estamos comprometidos!"
                      </p>
                  ...
                  <Card className="bg-white shadow-lg">
                    <CardContent className="p-6">
                      ...
                      <p className="text-gray-700 mb-3">
                        ...
                        confesó que estaba enamorada de mí de nuevo."
                      </p>
                  ...
                  <Card className="bg-white shadow-lg">
                    <CardContent className="p-6">
                      ...
                      <p className="text-gray-700 mb-3">
                        ...
                        mi número. Usé las técnicas de comunicación del Módulo 3 y hoy podemos resolver 
        ...
        Aquí está la tercera parte del código con el contenido textual traducido al español, manteniendo toda la estructura y sintaxis del código original intacta:
        {/* Oferta Principal */}
        <motion.div
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <h3 className="text-3xl font-bold text-white text-center mb-8">LO QUE VAS A RECIBIR:</h3>
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="bg-gradient-to-br from-gray-900 to-black border-2 border-orange-500 shadow-2xl">
              <CardContent className="p-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h5 className="text-xl font-bold text-orange-200 mb-4">📚 CONTENIDO PRINCIPAL:</h5>
                    <ul className="space-y-3 text-gray-300">
                      ...
                      <li className="flex items-center">
                        <Check className="w-5 h-5 text-green-400 mr-3" />
                        <span>✅ 21 Gatillos Emocionales Infalibles</span>
                      </li>
                      <li className="flex items-center">
                        <Check className="w-5 h-5 text-green-400 mr-3" />
                      ...
                      <li className="flex items-center">
                        <Check className="w-5 h-5 text-green-400 mr-3" />
                        <span>✅ Estrategias para cada tipo de ruptura</span>
                      </li>
                      <li className="flex items-center">
                        <Check className="w-5 h-5 text-green-400 mr-3" />
                        <span>✅ Cómo salir de la friendzone definitivamente</span>
                      </li>
                    </ul>
                  </div>

                  <div>
                    <h5 className="text-xl font-bold text-orange-200 mb-4">🎯 TAMBIÉN INCLUYE:</h5>
                    <ul className="space-y-3 text-gray-300">
                      <li className="flex items-center">
                        <Check className="w-5 h-5 text-green-400 mr-3" />
                        <span>📱 Acceso desde celular, tablet o computadora</span>
                      </li>
                      <li className="flex items-center">
                        <Check className="w-5 h-5 text-green-400 mr-3" />
                      ...
                      <li className="flex items-center">
                        <Check className="w-5 h-5 text-green-400 mr-3" />
                        <span>✅ Scripts de mensajes listos para usar</span>
                      </li>
                      <li className="flex items-center">
                        <Check className="w-5 h-5 text-green-400 mr-3" />
                        <span>✅ Herramientas de seguimiento de progreso</span>
                      </li>
                    </ul>
                  </div>
                </div>
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <h3 className="text-3xl font-bold text-white text-center mb-2">+ 5 BONOS EXCLUSIVOS</h3>
          <p className="text-orange-400 text-center font-semibold mb-8 text-xl">
            (¡Desbloqueaste {unlockedBonuses.length} de 5 en el quiz!)
          </p>
              ...
              >
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <h4 className="text-lg font-bold text-gray-900 mb-2">BONO #{bonus.id}</h4>
                    ...
                    <div className="bg-gray-100 p-3 rounded-lg mb-3 text-left text-sm text-gray-700">
                      <p>{getPersonalizedContent(bonus.description || "Descripción detallada de este bono exclusivo que acelerará tu reconquista.", userGender)}</p>
                    </div>
          ...
          <Card className="bg-gradient-to-br from-black to-gray-900 text-white shadow-2xl border-4 border-yellow-500">
            <CardContent className="p-8 text-center">
              <div className="mb-6">
                ...
                <div className="text-2xl text-orange-400 font-bold">O 3x DE R$ 12,33</div>
              </div>
              ...
              <p className="text-lg mb-6">¡Menos que el precio de un snack en el centro comercial!</p>
            </CardContent>
          </Card>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-400 text-sm mt-2">Haz clic aquí para ir directamente al checkout seguro</p>
        </motion.div>
        ...
        >
          <Card className="bg-red-600 text-white border-4 border-yellow-400">
            <CardContent className="p-8 text-center">
              ...
              <CountdownTimer />
              <p className="text-xl font-bold mt-4 text-yellow-300">¡Después de esto, vuelve al precio normal de R$ 297!</p>
            </CardContent>
          </Card>
        </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="bg-green-50 border-2 border-green-300">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-green-700 font-semibold mb-3">Resultados en 7 días o devolución integral</p>
                <p className="text-sm text-green-600">
                  Si no percibes ninguna señal positiva en los primeros 7 días, devolveremos el 100% de tu inversión sin cuestionamientos.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-purple-50 border-2 border-purple-300">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-purple-700 font-semibold mb-3">30 días sin cuestionamientos</p>
                <p className="text-sm text-purple-600">
                  Si por cualquier motivo no quedas satisfecho en los primeros 30 días, solo tienes que solicitarlo y devolveremos tu inversión íntegramente.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        >
          ...
          <div className="max-w-4xl mx-auto space-y-4">
            ...
            <Card className="bg-gray-800 border border-gray-700">
              <CardContent className="p-6">
                <h4 className="text-xl font-bold text-orange-400 mb-2">¿Cómo recibiré el acceso?</h4>
                <p className="text-gray-300">
